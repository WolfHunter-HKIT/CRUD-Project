...
insertItem.addEventListener("click", (e) => {
	...
	if (isEmpty(inputID, inputName, inputQuantity)) {
		return console.log(
			"Insert failed, input error occurred. (An empty field found)"
		);
	}
...
editItem.addEventListener("click", (e) => {
	...
	if (isEmpty(inputID)) {
		return console.log(
			"Edit failed, input error occurred. (An empty field found)"
		);
	}
	...
	if (idStorage.includes(localInputID)) {
		...
		return console.log(
			"Edit failed, input error occurred. (ID was not found.)"
		);
	}
...
deleteItem.addEventListener("click", (e) => {
	...
	if (idStorage.includes(localInputID)) {
		...
		alert("Item ID not found.");
		return console.log(
			"Removal failed, input error occurred. (ID was not found.)"
		);
	}
...
addToCart.addEventListener("click", (e) => {
	...
	if (
		idStorage.includes(localCartSelect) &&
		!cartIdStorage.includes(localCartSelect)
	) {
		console.log("Updating DOM...");
		let newRow = document.createElement("tr");
